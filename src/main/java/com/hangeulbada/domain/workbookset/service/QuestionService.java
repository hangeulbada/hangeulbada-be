...
public interface QuestionService {
    ...
    QuestionDto createQuestion(String teacherId, String workbookId, QuestionResponseDto questionsDto);
    WorkbookDto getQuestionsToCreate(String teacherId, String workbookId, List<QuestionResponseDto> questions);
